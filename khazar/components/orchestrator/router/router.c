...
router_t *router_init(registry_t *reg) {
    ...
    const char *pairs[][2] = {
        ...
        {"shutdown", "system_management"},
        {"reboot", "system_management"},
        {"baglat", "system_management"},
        {"bağlat", "system_management"},
        {"yeniden baslat", "system_management"},
        {"yenidən başlat", "system_management"},
        {"kilidle", "system_management"},
        {"kilidlə", "system_management"},
        {"lock", "system_management"},
        {"ses", "audio_control"},
        {"səs", "audio_control"},
        {"volume", "audio_control"},
        {"mute", "audio_control"},
        {"parlaqliq", "brightness_control"},
        {"parlaqlıq", "brightness_control"},
        {"brightness", "brightness_control"},
        {"screenshot", "screenshot"},
        {"ekran", "screenshot"},
        {"update", "system_update"},
        {"yenile", "system_update"},
        {"yenilə", "system_update"},
    };
